...
export const TechStack = () => {
    const techList: string[] = ["Salesforce Administrator", "React", "Next.js", "SOLID", "TailwindCSS", "Testing", "Bigcommerce", "NodeJS", "Typescript", "Javascript", "Java", "Spring", "MondoDB", "MySQL", "Express", "Scrum", "AWS", "VueJS", "Angular", "Pattern Design"];
